...
-(void)createUI{
    if(!self.addPhotoTable)
    {
       ...
       // self.addPhotoTable.frame=CGRectMake(0, 55, self.view.frame.size.width, self.view.frame.size.height-50);
        ...
        self.addPhotoTable.backgroundColor=[UIColor colorWithRed:(CGFloat)255/255 green:(CGFloat)148/255 blue:(CGFloat)214/255 alpha:1.0];
        self.addPhotoTable.separatorColor=[UIColor colorWithRed:(CGFloat)255/255 green:(CGFloat)148/255 blue:(CGFloat)214/255 alpha:1.0];
